...
# RASPI_DEFCONFIG=configs/raspberrypi4_64_defconfig
# # AESD_DEFAULT_DEFCONFIG=${RASPI_DEFCONFIG}

# MODIFIED_RASPI_DEFCONFIG=base_external/configs/aesd_raspi_defconfig
# # AESD_MODIFIED_DEFCONFIG=${MODIFIED_RASPI_DEFCONFIG}
# # AESD_MODIFIED_DEFCONFIG_REL_BUILDROOT=../${MODIFIED_RASPI_DEFCONFIG}